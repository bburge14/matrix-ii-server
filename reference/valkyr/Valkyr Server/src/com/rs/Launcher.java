...
public final class Launcher {
	...
	public static void main(String[] args) throws Exception {
		...
		ItemSpawns.init();
		Huffman.init();
		//Logger.log("Vuse-RSPS", "Loaded Cache...");
		...
		try {
			...
			Logger.handle(e);
			Logger.log(Settings.SERVER_NAME, "Failed initing Server Channel Handler. Shutting down...");
			System.exit(1);
			return;
		}
		Logger.log(Settings.SERVER_NAME, "Server took "
