...
public final class Settings {
	...
	public static final String SERVER_NAME = "Valkyr";
	public static final String MASTER_PASSWORD = "1234";
	public static final int PORT_ID = 43594;
	public static final String LASTEST_UPDATE = "<col=ffff00><img=1>Development Process!</col><img=1>";
	...
	public static final double BUILD_NUMBER = 1.11;
	
	/**
	 * Link settings
	 */
	
	public static final String WEBSITE_LINK = "http://valkyr.com/";
	public static final String ITEMLIST_LINK = "http://itemdb.biz";
	public static final String ITEMDB_LINK = "http://itemdb.biz";
	public static final String VOTE_LINK = "http://motivoters.com/vote/165/";
	public static final String RAGE_SKYPE = "";
	public static final String GUIDE_LINK = "http://www.valkyr.com/";
	public static final String DONATE_LINK = "http://valkyr.com/donate";
	public static final String HISCORES = "http://valkyr.com/highscores/";
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2758, 3510, 0);
	public static final WorldTile[] RESPAWN_PLAYER_LOCATION = { new WorldTile(2758, 3510, 0) };
	public static final WorldTile[] HOME_PLAYER_LOCATION = { new WorldTile(2758, 3510, 0) };
	public static final long MAX_PACKETS_DECODER_PING_DELAY = 30000; 
	public static int XP_RATE = 50; 
	public static int COMBAT_XP_RATE = 50;
	...
	public static final int TOTAL_QUEST_POINTS = 3;
	...
	public static final String[] OWNER_NAMES = {"andy", "", ""};
											 //local host    
	public static final String[] ADMIN_IPS = {"127.0.0.1", "184.155.245.22", ""};
     ...
     * NPC settings
     */
    public static final int[] NON_WALKING_NPCS1 = {9085 , 8275, 8274, 8273, 1598 }; //Npc id's; jellyDemario<3
