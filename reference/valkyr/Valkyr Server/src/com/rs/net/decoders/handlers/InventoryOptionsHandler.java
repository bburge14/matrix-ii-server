...
import com.rs.game.player.content.AmuletAttaching;
...
public class InventoryOptionsHandler {
	...
	public static void handleItemOption2(final Player player, final int slotId,
		...
		if (itemId == 31612) {
			SpringCleaner.getCharges(player);
			return;
		}
		if (itemId == 18339) {
			if (player.coal <= 0) {
	...
	public static void handleItemOption1(final Player player, final int slotId,
		...
		if (itemId == 30920) {
			player.sm("You currently have " + player.silverhawkCharges + " charges remaining.");
		}
		if (itemId == 28547 || itemId == 28548 || itemId == 28549)  {
		...
		player.sm("you need all 3 pieces to make a triskelion key.");
		}
		}
	
		if (itemId == 30915) {
			if (player.getInventory().containsItem(30920, 1) || player.getEquipment().getBootsId() == 30920) {
				int charges = player.silverhawkCharges;
				int maxCharges = 500;
				if (!(charges + item.getAmount() > maxCharges)) {
					player.getInventory().deleteItem(item);
					player.silverhawkCharges += item.getAmount();
					player.sm("You add " + item.getAmount() + " charges to your Silverhawk boots.");
				} else {
					player.sm("You can't put that many charges in these boots. You can only have upto 500.");
					player.sm("You currently have " + player.silverhawkCharges + " charges.");
				}
			}
		}
		...
		if (itemId == 29863) {
			player.getDialogueManager().startDialogue("SirenicMaking");
			return;
		}
        ...
        if (itemId == 29492) {
            player.getDialogueManager().startDialogue("ExchangeBond");
        }
		if (itemId == 4613) {
		...
		if (player.isExtremeDonator()) {
			...
			if (player.getUsername().equals("andy"))
				flower = 299;
		...
		if (itemId == 985 || itemId == 987) {
			if (player.getInventory().containsItem(985, 1) && player.getInventory().containsItem(987, 1)) {
				...
				player.getSkills().addXp(Skills.CRAFTING, 0.5);
			}
		}
		if (itemId == 31612) {
		...
		if (itemId == 31613) {
			SpringCleaner.chargeCleaner(player, item);
		}
		//boss pets start
		/*if (itemId == 33833) {//Saradomin
			if (player.getInventory().containsItem(33833, 1)) {
					player.getInventory().deleteItem(33833, 1);
					player.getInventory().addItem(33807, 1);
					player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}*/
		/*if (itemId == 33830) {//Armadyl
			if (player.getInventory().containsItem(33830, 1)) {
				player.getInventory().deleteItem(33830, 1);
				player.getInventory().addItem(33778, 1);
				player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}*/
		/*if (itemId == 33832) {//Bandos
		...
		/*if (itemId == 33842) {//Kbd
			if (player.getInventory().containsItem(33842, 1)) {
				...
				player.getInventory().addItem(33792, 1);
				player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}*/
		/*if (itemId == 33849) {//Qbd
		...
		if (itemId == 33851) {//rex
			if (player.getInventory().containsItem(33851, 1)) {
				...
				player.getInventory().addItem(33801, 1);
				player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}
		if (itemId == 33852) {//supreme
			if (player.getInventory().containsItem(33852, 1)) {
				player.getInventory().deleteItem(33852, 1);
				player.getInventory().addItem(33800, 1);
				player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}
		if (itemId == 33850) {//prime
			if (player.getInventory().containsItem(33850, 1)) {
				player.getInventory().deleteItem(33850, 1);
				player.getInventory().addItem(33802, 1);
				player.getPackets().sendGameMessage("A Magical slut appears in your inventory");
			}
		}
		if (itemId == 33716) {//bombie
		...
		if (itemId == 28436) {
			if (player.getInventory().containsItem(28436, 50) && (player.getSkills().getLevel(Skills.FLETCHING) >= 90)) {
				player.getInventory().deleteItem(28436, 50);
				player.getInventory().addItem(28465, 50);
				player.getSkills().addXp(Skills.FLETCHING, 100);
				player.sm("You make 50 Ascension bolts.");
			} else {
				player.sm("You need at least 50 Ascension shards and 90 Fletching to make these.");
				return;
			}
		}
		if (itemId == 29933 || itemId == 29934 || itemId == 29935) {
			if (player.getInventory().containsItems(new Item[] { new Item(29933), new Item(29934), new Item(29935)})) {  // checks inventory for 3 pieces
				CombineMoO(player);
				return;
			}
			else {
				player.getPackets().sendGameMessage("You need all 3 pieces of the " + "Maul to combine it."); //if you don't have 3 pieces
			}
		}
		if (itemId == 6199) {
			if (player.getInventory().containsItem(6199, 1)) {
			int[] Common = { 21371, 26198, 6585, 6735, 11694, 11696, 11698, 11700 };
			int[] Uncommon = { 11724, 11726, 11728, 25022, 25025, 11718, 11720, 11722, 25010, 25016, 25037, 24992, 24995, 24998, 25001, 25004, 25007 };
			int[] Rare = { 18349, 18351, 18353, 18355, 18357, 25991, 25995, 25993, 31449, 31463 };
			int[] SuperRare = { 31725, 31729, 31733, 30005, 30008, 30011, 30014, 29854, 29857, 29860, 28608, 28611, 28614, 28617, 28621, 28437, 28441, 26579, 26583, 26587, 26591, 26595, 26599 };
			int[] Legendary = { 1038, 1040, 1042, 1044, 1046, 1048, 1050, 30412, 1053, 1055, 1057, 1962, 962, 981, 1989, 33625 };
		...
		if (rarity > 0 && rarity <= 600)  {
            ...
            player.setNextGraphics(new Graphics(4771));
			String reward2 = ItemDefinitions.getItemDefinitions(Common[reward]).getName().toLowerCase();
			//World.sendWorldMessage("<img=5><col=FFFF00>" + player.getDisplayName() + "<col=FFFF00> has received<col=FFFF00> " + reward2 + "<col=FFFF00> from a Donator Box!<img=5>", false);	
		}
		if (rarity > 600 && rarity <= 900)  {
			...
			String reward2 = ItemDefinitions.getItemDefinitions(Uncommon[reward]).getName().toLowerCase();
			player.setNextGraphics(new Graphics(4771));
			//World.sendWorldMessage("<img=5><col=FFFF00>" + player.getDisplayName() + "<col=FFFF00> has received<col=FFFF00> " + reward2 + "<col=FFFF00> from a Donator Box!<img=5>", false);
		}
		if (rarity > 900 && rarity <= 970)  {
			...
			String reward2 = ItemDefinitions.getItemDefinitions(Rare[reward]).getName().toLowerCase();
			player.setNextGraphics(new Graphics(4771));
			//World.sendWorldMessage("<img=5><col=FF0000>" + player.getDisplayName() + "<col=FF0000> has received<col=FF0000> "+ reward2 + "<col=FF0000> from a Donator Box!<img=5>", false);		
		}
		if (rarity > 970 && rarity <= 997)  {
			...
			String reward2 = ItemDefinitions.getItemDefinitions(SuperRare[reward]).getName().toLowerCase();
			player.setNextGraphics(new Graphics(4771));
			//World.sendWorldMessage("<img=8><col=B40404>" + player.getDisplayName() + "<col=B40404> has received<col=B40404> " + reward2 + "<col=B40404> from a Donator Box!<img=8>", false);	
		}
		if (rarity > 997 && rarity <= 1000)  {
			...
			player.setNextGraphics(new Graphics(4771));
			String reward2 = ItemDefinitions.getItemDefinitions(Legendary[reward]).getName().toLowerCase();
			//World.sendWorldMessage("<img=8><col=2E64FE>" + player.getDisplayName() + "<col=2E64FE> has received<col=2E64FE> " + reward2 + "<col=2E64FE> from a Donator Box!<img=8>", false);
		}	
		return;
		}
		}
		...
		if (itemId == 5070) {
			...
			player.getInventory().addItemDrop(5075, 1);
		}
		...
		if (itemId == 20704) {
            ...
            player.sm("Please use the magic orb to bunch your plants.");
		}
	...
	public static void handleItemOnItem(final Player player, InputStream stream) {
		...
		if (interfaceId == Inventory.INVENTORY_INTERFACE
			...
			if (itemUsed.getId() == 27068 || usedWith.getId() == 11716) {
				if (player.getInventory().containsItem(27068, 10) 
				 && player.getInventory().containsItem(11716, 1)) {
					player.getInventory().deleteItem(27068, 10);
					player.getInventory().deleteItem(11716, 1);
					player.getInventory().addItem(31463, 1);
					player.getPackets().sendGameMessage("You attatch the spikes on the end of the spear.");
				} else {
					player.getPackets().sendGameMessage("You need at least 10 chaotic spikes to make a chaotic spear.");
				}
			}
			if (itemUsed.getId() == 31449 || usedWith.getId() == 25028) {
				if (player.getInventory().containsItem(31449, 1) 
				 && player.getInventory().containsItem(25028, 1)) {
					player.getInventory().deleteItem(31449, 1);
					player.getInventory().deleteItem(25028, 1);
					player.getInventory().addItem(31448, 1);
					player.getPackets().sendGameMessage("You attach the chaotic remnant to you're saradomin's whisper.");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31449 || usedWith.getId() == 25034) {
				if (player.getInventory().containsItem(31449, 1) 
				 && player.getInventory().containsItem(25034, 1)) {
					player.getInventory().deleteItem(31449, 1);
					player.getInventory().deleteItem(25034, 1);
					player.getInventory().addItem(31445, 1);
					player.getPackets().sendGameMessage("You attach the chaotic remnant to you're saradomin's murmur.");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 11663) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(11663, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(11663, 1);
					player.getInventory().addItem(31644, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Mage Helm .");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 11664) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(11664, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(11664, 1);
					player.getInventory().addItem(31645, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Range Helm .");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 11665) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(11665, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(11665, 1);
					player.getInventory().addItem(31646, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Melee Helm .");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 8842) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(8842, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(8842, 1);
					player.getInventory().addItem(31643, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Gloves .");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 8839) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(8839, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(8839, 1);
					player.getInventory().addItem(19785, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Top.");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			if (itemUsed.getId() == 31640 || usedWith.getId() == 8840) {
				if (player.getInventory().containsItem(31640, 1) 
				 && player.getInventory().containsItem(8840, 1)) {
					player.getInventory().deleteItem(31640, 1);
					player.getInventory().deleteItem(8840, 1);
					player.getInventory().addItem(31642, 1);
					player.getPackets().sendGameMessage("You attach the Void knight Armour Patch to you're Void Knight Bottom.");
				} else {
					player.getPackets().sendGameMessage("You Don't have the correct items to make this item.");
				}
			}
			...
			if (itemUsed.getId() == 11710 || usedWith.getId() == 11712 || usedWith.getId() == 11714) {
				...
				//Ascension Crossbows
				if (itemUsed.getId() >= 28457 && itemUsed.getId() <= 28462 && usedWith.getId() == 25917) {
					player.getDialogueManager().startDialogue("CrossbowMaking");
				}
                //Ganodermic robes
			...
			//Bolt Tip Making
				...
				player.getInventory().addItem(13744, 1);
				player.getPackets().sendGameMessage("You force the sigil upon the blessed spirit shield making it unleash Spectral Powers.");
				} else if (itemUsed.getId() == 1759 && usedWith.getId() == 1673) {
                    player.getInventory().deleteItem(1759, 1);
                ...
                } else if (itemUsed.getId() == 1759 && usedWith.getId() == 1675) {
                    player.getInventory().deleteItem(1759, 1);
                ...
                } else if (itemUsed.getId() == 1759 && usedWith.getId() == 1677) {
                    player.getInventory().deleteItem(1759, 1);
                ...
                } else if (itemUsed.getId() == 1759 && usedWith.getId() == 1679) {
                    player.getInventory().deleteItem(1759, 1);
                ...
                } else if (itemUsed.getId() == 1759 && usedWith.getId() == 1681) {
                    player.getInventory().deleteItem(1759, 1);
	...
	public static void handleItemOption3(Player player, int slotId, int itemId,
		...
		if (player.getLockDelay() >= time
			...
			return;
		player.stopAll(false);
		if (itemId == 20767 || itemId == 20769 || itemId == 20771 || itemId == 32152 || itemId == 32151)
				...
				for (WorldObject object : World.getRegion(player.getRegionId()).getAllObjects()) {
					if (object.withinDistance(player, 1)) {
						switch (object.getId()) {
							...
							case 3510:
							case 3508:
								World.spawnTemporaryObject(new WorldObject(object.getId() + 1, object.getType(), object.getRotation(), object.getX(), object.getY(), object.getPlane()), 30000);
	...
	public static void handleItemOption8(Player player, int slotId, int itemId, Item item) {
		...
		if (player.getRights() <= 2)
			player.getPackets().sendGameMessage("Item Name: " + item.getName() + " Item ID: " + itemId + "  Slot ID: " + slotId);
	}
	...
	public static void handleItemOnNPC(final Player player, final NPC npc, final Item item) {
		...
		player.setCoordsEvent(new CoordsEvent(npc, new Runnable() {
			...
			public void run() {
				...
				if (npc.getId() == 3234) {
					int[] birdNests = { 5070, 5070, 5071, 5072, 5073, 5074, 5075 };
					int randomNest = birdNests.length;
					randomNest--;
					int product = Utils.getRandom(randomNest);
					if (item.getId() == 7416 || item.getId() == 7417 || item.getId() == 7418 || item.getId() == 7419) { //skins and shit
						int nestAmount = player.getInventory().getAmountOf(item.getId());
						player.getInventory().deleteItem(item.getId(), nestAmount);
						player.getInventory().addItem(birdNests[product], nestAmount);			
						player.sm("Your bird nests have been added to your inventory.");
						return;
					}				
					player.sm("You need mole skins or claws to do that.");
					return;
				}
				if (npc.getId() == 519) {
	...
	private static void CombineMoO(final Player player) {
		player.getInventory().deleteItem(29933, 1);
		player.getInventory().deleteItem(29934, 1);
		player.getInventory().deleteItem(29935, 1);
		player.getInventory().addItem(29936, 1);
