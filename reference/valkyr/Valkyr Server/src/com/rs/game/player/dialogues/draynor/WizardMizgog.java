...
public class WizardMizgog extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 11:
			...
			player.getQuestManager().setQuestStage(Quests.IMP_CATCHER, 1);
		...
		case 26:
			...
			player.getQuestManager().completedQuest(Quests.IMP_CATCHER);
			player.getQuestManager().setQuestStage(Quests.IMP_CATCHER, 2);
			end();
			break;
		}
	}
