...
//Main structure NAME(Broken itemId, repaired itemId,Price to repair it)
		...
		TORVA_HELM(20138, 20135, 15000000),

		TORVA_PLATE(20142, 20139, 15000000),

		TORVA_LEGS(20146, 20143, 15000000),

		TORVA_GLOVES(24979, 24977, 15000000),

		TORVA_BOOTS(24985, 24983, 15000000),
		...
		ZARYTE_BOW(20174, 20171, 40000000),

		VIRTUS_MASK(20162, 20159, 15000000),

		VIRTUS_TOP(20166, 20163, 15000000),

		VIRTUS_LEGS(20170, 20167, 15000000),

		VIRTUS_GLOVES(24982, 24980, 15000000),

		VIRTUS_BOOTS(24988, 24986, 15000000);
