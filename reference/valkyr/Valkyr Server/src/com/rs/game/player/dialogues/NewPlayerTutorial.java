...
public class NewPlayerTutorial extends Dialogue {
	...
	public void start() {
		...
		sendDialogue("Guthix Priest",
						"Welcome to " + Settings.SERVER_NAME + ", " + player.getUsername() + ".",
	...
	public void run(int interfaceId, int componentId) {
		if (stage == 2) {
			...
			sendDialogue("This is the Player Support Tab.",
						 ...
						 "to help improve your game experience and " + Settings.SERVER_NAME + ".");
			stage = 3;
		}
		 ...
		 */
			...
			sendDialogue("To begin training, it is suggested to go",
						 "to the Rock Crabs. To get around " + Settings.SERVER_NAME + ",simply use your Crystal Teleport.");
			stage = 9;
		}
		}
