...
public final class Woodcutting extends Action {
	...
	public static enum TreeDefinitions {
		...
		CRYSTAL_1(94, 434.5, -1, 130, 19, 87539, 200, 10),
		
		CRYSTAL_2(94, 434.5, -1, 130, 19, 87540, 200, 10),
		
		CRYSTAL_3(94, 434.5, -1, 130, 19, 87541, 200, 10),
	...
	private void addLog(Player player) {
		...
		if (definitions == TreeDefinitions.CRYSTAL_1 || definitions == TreeDefinitions.CRYSTAL_2 || definitions == TreeDefinitions.CRYSTAL_3) {
			player.getPackets().sendGameMessage("You cut a piece of crystal off the shard.", true);
			return;
		}
