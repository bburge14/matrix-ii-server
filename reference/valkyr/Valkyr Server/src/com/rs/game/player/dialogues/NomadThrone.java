...
public class NomadThrone extends Dialogue {
	...
	public void start() {
		...
		sendNPCDialogue(npcId, 9785, "Hello there. ");//player.getQuestManager().getQuestStage(Quests.NOMADS_REQUIEM) != 2 ? "The assassin aproaches, but I wonder what compels you to seek death." : "The assassin returns? Whomever perserved your life must delight in your suffering!" );
	}
