...
public final class DialogueHandler {
	...
	public static final void init() {
		try {
			...
			handledDialogues.put("Training", value95);
			Class<Dialogue> value96 = (Class<Dialogue>) Class
					.forName(RagoWeek.class.getCanonicalName());
			handledDialogues.put("RagoWeek", value96);
			Class<Dialogue> value97 = (Class<Dialogue>) Class
					.forName(PkPortal.class.getCanonicalName());
			handledDialogues.put("PkPortal", value97);
			Class<Dialogue> value150 = (Class<Dialogue>) Class
					.forName(DonationStore.class.getCanonicalName());
			handledDialogues.put("DonationStore", value150);
			
			
			
			handledDialogues.put("AllAltars", (Class<Dialogue>) Class.forName(AllAltars.class.getCanonicalName()));
            ...
            handledDialogues.put("ExchangeBond", (Class<Dialogue>) Class.forName(ExchangeBond.class.getCanonicalName()));
            handledDialogues.put("Scavvo", (Class<Dialogue>) Class.forName(Scavvo.class.getCanonicalName()));	
            handledDialogues.put("IronManSelect", (Class<Dialogue>) Class.forName(IronManSelect.class.getCanonicalName()));	
            ...
            handledDialogues.put("ShipManager", (Class<Dialogue>) Class.forName(ShipManager.class.getCanonicalName()));			
            ...
            handledDialogues.put("CrossbowMaking", (Class<Dialogue>) Class.forName(CrossbowMaking.class.getCanonicalName()));
			handledDialogues.put("SirenicMaking", (Class<Dialogue>) Class.forName(SirenicMaking.class.getCanonicalName()));
