...
import com.rs.game.player.quest.impl.CooksAssistant;
...
public class Lumbridge {
	...
	public static void FindSkull(Player player, final WorldObject object) {
		if (player.getQuestManager().getQuestStage(Quests.THE_RESTLESS_GHOST) == 3) {
			player.getInventory().addItemDrop(553, 1);
			...
			player.sm("You search the rock and find nothing...");
		}
	}
	
	public static void HandleCoffin(Player player, final WorldObject object) {
