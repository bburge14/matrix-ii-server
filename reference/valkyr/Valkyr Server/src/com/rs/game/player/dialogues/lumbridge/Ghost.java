...
public class Ghost extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			sendNPCDialogue(457, 9827, "Well, to be honest , I'm not sure, ", "I should think it's becuse i've lost my head.");
			stage = 9;
		} else if (stage == 9) {
			sendPlayerDialogue( 9827, "What? I can see your head perfectly fine. Well, see ", "through it at least.");
			stage = 10;
		} else if (stage == 10) {
			...
			sendPlayerDialogue( 9827, "Okay. I'll try to get your skull back for you so you", "can rest in peace.");
			player.getQuestManager().setQuestStageAndRefresh(Quests.THE_RESTLESS_GHOST, 4);
			end();
		}
	}
