	...
	public void run(int interfaceId, int componentId) {
		if (stage == 1) {
			if (componentId == OPTION_1) { //home
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2957, 3217, 0));
				...
				sendOptionsDialogue("Minigames", "Barrows", "The RuneSpan", "Warriors Guild", "Crucible", "Next Page" );
				stage = 7;
			} else if (componentId == OPTION_3) {//Skilling locations
				sendOptionsDialogue("Skilling Locations", "Woodcutting", "Thieving", "Fishing", "Hunter", "Next Page");
				stage = 4;
			} else if (componentId == OPTION_4) {//Bossing Teleports

			} else if (componentId == OPTION_5) {//page 2 of teleport options
				sendOptionsDialogue("Teleport Options", "PvP", "Prayers/Spellbooks");
				stage = 6;
			}
			...
			if (componentId == OPTION_1) { 
				...
				sendOptionsDialogue("Skilling Teleports - Page 2", "Agility", "Mining", "Smithing", "Farming", "More" );
				stage = 10;
			}
