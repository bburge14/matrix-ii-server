...
public class JewllerySmithing {
    ...
    private static final int[][] ITEMS = {{1635, 1637, 1639, 1641, 1643, 1645, 1647}, {1654, 1656, 1658, 1660, 1662, 1664, 1666}, { 1673, 1675, 1677, 1679, 1681, 1685, 6566 }, {11069, 11072, 11076, 11085, 11092, 11115, 11067}};
    ...
    private static void callCS2(Player player) {
        for (int primaryIndex = 0; primaryIndex < COMPONENTS_BASE.length; primaryIndex++) {
            for (int secondaryIndex = 0; secondaryIndex < ITEMS[primaryIndex].length; secondaryIndex++) {
                ...
                player.getPackets().sendUnlockIComponentOptionSlots(INTERFACE, 70, 0, 28, 0, 1, 2, 3);
            }
        }
    }

    public static void handleButtonClick(Player player, int componentId, final int tick) {
    	if (componentId == 70 && player.getInventory().containsItems(new Item(2357), new Item(6573)) && player.getSkills().getLevel(Skills.CRAFTING) >= 90) {
    		player.getInventory().deleteItem(new Item(2357, 1));
    		player.getInventory().deleteItem(new Item(6573, 1));
    		player.getInventory().addItem(new Item(6579, 1));
