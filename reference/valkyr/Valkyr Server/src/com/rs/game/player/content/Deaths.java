...
public class Deaths implements Serializable {
	...
	public enum Tasks {
		...
		GLACOR(14301, 15, 20, 500),
		KING_BLACK_DRAGON(50, 15, 40, 800),
		CORPOREAL_BEAST(8133, 1, 10, 800),
		NEX(13447, 1, 5, 1000),
		GENERAL_GRAARDOR(6260, 10, 25, 800),
		COMMANDER_ZILYANA(6247, 10, 25, 800),
		KRIL_TSUTSAROTH(6203, 10, 25, 800),
		KREE_ARRA(6222, 10, 25, 800),
		VORAGE(17182, 5, 10, 1500),
		KALPHITEKING(16698, 2, 5, 2000),
		KALPHITEKING1(16699, 2, 5, 2000),
		KALPHITEKING2(16697, 2, 5, 2000),
        KALPHITE_QUEEN(16708, 5, 10, 800);
