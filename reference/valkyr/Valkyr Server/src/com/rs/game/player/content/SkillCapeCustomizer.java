...
public final class SkillCapeCustomizer {
	...
	public static void resetSkillCapes(Player player) {
		...
		player.setMaxedCapeCustomized(Arrays.copyOf(ItemDefinitions.getItemDefinitions(32151).originalModelColors, 4));
		player.setCompletionistCapeCustomized(Arrays.copyOf(ItemDefinitions.getItemDefinitions(20769).originalModelColors, 4));
		player.setCompletionistCapeCustomized(Arrays.copyOf(ItemDefinitions.getItemDefinitions(32152).originalModelColors, 4));
		player.setCompletionistCapeCustomized(Arrays.copyOf(ItemDefinitions.getItemDefinitions(32153).originalModelColors, 4));
	...
	public static void handleSkillCapeCustomizer(Player player, int buttonId) {
		...
		if (buttonId == 58) { // reset
			...
			if (capeId == 20769 || capeId == 32152 || capeId == 32153)
