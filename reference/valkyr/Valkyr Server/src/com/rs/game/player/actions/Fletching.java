...
public class Fletching extends Action {
	...
	public static enum Fletch {
         ...
         */
       	...
       	BROAD_BOLTS(13279, 314, new int [] {13280}, new int[] {55}, 
                new double[] {30}, new Animation(-1)),
		
		BROAD_ARROWS(13278, 53, new int[] {4160}, new int[] {52}, 
                new double[] {225}, new Animation(-1)); 
	...
	public static boolean maxMakeQuantityFifteen(Fletch fletch) {
		return fletch.getSelected() == 314 || fletch.getSelected() == 53 || fletch.getSelected() == 882 
            || fletch.getSelected() == 884 || fletch.getSelected() == 886 || fletch.getSelected() == 888
            || fletch.getSelected() == 890 || fletch.getSelected() == 892 || fletch.getSelected() == 52
	...
	public int processWithDelay(Player player) {
		ticks--;
		boolean isShaft = fletch.getProduct()[option] == 52;
		int amount = maxMakeQuantityFifteen(fletch) || isShaft ? 15 : 1;
		if (player.KarateFletching == true) {
			player.setNextAnimation(new Animation(17299));
			player.setNextGraphics(new Graphics(3300));
			player.getInventory().deleteItem(fletch.getId(), isShaft ? 1 : amount);
		} else {
