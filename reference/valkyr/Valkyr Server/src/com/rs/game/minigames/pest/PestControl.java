...
public class PestControl {
	...
	if (knight.isDead())
	    ...
	    player.getDialogueManager().startDialogue("SimpleMessage", "Congradulations! You have successfully kept the lander safe and have been awarded: " + coinsAmount + " gold coins and 25 commendation points.");
	    player.getInventory().addItemMoneyPouch(new Item(995, coinsAmount));
	    player.pestPoints += 25;
	    player.pestWins++;
	}
    }
