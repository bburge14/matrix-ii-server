...
public class Class355 implements Interface19 {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = client.aClass283_8716.method2641(-1837734772).getObjectDefinitions(i_10_).method5770(i_11_, class497.aString6101, 1595133323);
	    else
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (client.aClass283_8716.method2641(767453715).getObjectDefinitions(i_10_).method5776(i_11_, class497.anInt6100 * -388931549, (byte) 2));
	}
	catch (RuntimeException runtimeexception) {
