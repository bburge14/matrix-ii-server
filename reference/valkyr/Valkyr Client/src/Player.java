...
public class Player extends Entity {
	...
	public Player(Class331 class331, int i) {
		...
		ch = 0;
		che = false;
		ccat = new cat((byte)0, (byte)0, (byte)0);
		ccat.m = false;
	}
		...
		try {
			...
			if (0 != 780357347 * anInt10214) {
				...
				if(cprgbe) {
					...
					if(ccat.cr == -105 && ccat.cg == 50 && ccat.cb == -123)
						ccat.m = true;
					else
						ccat.m = false;
				}
				...
				for (int i_30_ = client.aClass19Array8869.length - 1; i_30_ >= 0; i_30_--) {
					...
					if (null != class19 && class19.anInt263 * 408071539 != -1) {
						if (958933333 * class19.anInt266 == 1) {
							Class298_Sub29 class298_sub29 = ((Class298_Sub29) (client.aClass437_8696.get((long) (-841622081 * class19.anInt256))));
