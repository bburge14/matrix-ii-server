...
public class ObjectDefinitions {
	...
	void decode(RsByteBuffer stream, int opcode, int i_0_) {
		try {
			if (1 == opcode) {
				...
				switch ((objectId * 1181652947)) {
				
					case 14053:
						name = "Valkyr Teleporter";
						editOption(0, "Teleport");
						editOption(1, null);
						editOption(2, null);
						editOption(3, null);
						editOption(4, null);
	...
	public void editOption(int optionNumber, String optionName) {
		this.options[optionNumber] = optionName;
	}
}
