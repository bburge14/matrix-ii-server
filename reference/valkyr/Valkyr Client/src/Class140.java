...
public class Class140 implements Runnable {
	...
	try {
	    ...
	    int i_14_ = i_13_ / 4 * 3;
	    if (i_13_ - 2 >= i_12_ || (ClanChatUser.method1773(string.charAt(i_13_ - 2), 1186467127) == -1))
		i_14_ -= 2;
	    else if (i_13_ - 1 >= i_12_ || ClanChatUser.method1773(string.charAt(i_13_ - 1), 1292628022) == -1)
		i_14_--;
