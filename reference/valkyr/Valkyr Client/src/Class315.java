		...
		try {
			...
			if (SubIncommingPacket.aClass206_2347 == class206) {
				...
				if (client.aClass283_8716.method2674(-135283377) != Class266.aClass266_2846) {
					if (i_41_ >= 0 && i_42_ >= 0 && (i_41_ < client.aClass283_8716.method2629(-2115187525)) && i_42_ < client.aClass283_8716.method2630(1222512663) && i_43_ >= 0 && i_44_ >= 0 && (i_43_ < client.aClass283_8716.method2629(-2121627992)) && (i_44_ < client.aClass283_8716.method2630(-2081531222)) && gfx != 65535) {
						i_41_ = 256 + 512 * i_41_;
						i_42_ = 256 + 512 * i_42_;
						i_43_ = 256 + i_43_ * 512;
						i_44_ = i_44_ * 512 + 256;
						...
						endHeight <<= 2;
						fromSizeAndSlope <<= 2;
						Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(client.aClass283_8716.method2675(-1611682495), gfx, -191892109 * Class375.basePlane, Class375.basePlane * -191892109, i_41_, i_42_, startHieght, delay + client.ticketCycle * 443738891, client.ticketCycle * 443738891 + delayAndSpeed, angle, fromSizeAndSlope, 0, i_45_, endHeight, bool, -1));
						class365_sub1_sub1_sub1.method4405(i_43_, i_44_, Class356.method4271(i_43_, i_44_, (-191892109 * Class375.basePlane), -1671970391) - endHeight, 443738891 * client.ticketCycle + delay, -53743739);
				...
				if (null != client.aClass437_8685) {
					Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685.get((long) (-191892109 * Class375.basePlane << 28 | i_64_ << 14 | i_66_))));
				...
				Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685.get((long) (Class375.basePlane * -191892109 << 28 | i_144_ << 14 | i_146_))));
				if (class298_sub2 != null) {
