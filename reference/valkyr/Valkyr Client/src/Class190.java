	...
	static final void method1857(Class403 class403, int i) {
		try {
			...
			if (client.anInt8942 * 1131012101 != 0 && i_5_ < -548972447 * client.anInt8952) {
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = client.aStringArray8859[i_5_];
				if (null != client.aStringArray8955[i_5_])
					((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = client.aStringArray8955[i_5_];
				else
