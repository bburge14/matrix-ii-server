	...
	static void method4939(Class298_Sub37_Sub15 class298_sub37_sub15, int i, int i_30_, short i_31_) {
		try {
			if (null != class298_sub37_sub15 && (Class436.aClass453_5480.aClass298_5643 != class298_sub37_sub15)) {
				...
				if (i_34_ >= 2000)
					i_34_ -= 2000;
				WorldTile class341 = client.aClass283_8716.method2628(681479919);
				if (23 == i_34_) { // walk
				...
				if (class198 != null) {
					...
					client.anInt8786 = 0;
					Class298_Sub36 class298_sub36 = Class18.method359(class198, client.aClass25_8711.aClass449_330,
							(byte) 23);
				...
				if (59 == i_34_) { // ?????
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2087,
							client.aClass25_8711.aClass449_330, (byte) 6);
					...
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(client.usedId * 1408085039);
				...
				if (2 == i_34_) { // widget on object
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_OBJECT,
							client.aClass25_8711.aClass449_330, (byte) 52);
					class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(Class151.method1644(-427290804) ? 1 : 0,
							(byte) 1);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(client.usedId * 1408085039, 0);
				...
				if (class198_36_ != null) {
					...
					if (null != player) {
						...
						Class298_Sub36 class298_sub36 = Class18.method359(class198_36_,
								(client.aClass25_8711.aClass449_330), (byte) 74);
				...
				if (i_34_ == 16) { // widget on self player, no path needed
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_PLAYER,
							client.aClass25_8711.aClass449_330, (byte) 82);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(1408085039 * client.usedId, 16711935);
				...
				if (i_34_ == 17) { // widget on ground item???
					...
					Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2062,
							client.aClass25_8711.aClass449_330, (byte) 15);
				...
				if (null != class198_37_) {
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) client.aClass437_8696.get((long) walktype));
				...
				if (packet != null) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(packet, client.aClass25_8711.aClass449_330,
							(byte) 94);
				...
				if (8 == i_34_) { // widget on npc
					...
					if (class298_sub29 != null) {
						...
						Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_NPC,
								(client.aClass25_8711.aClass449_330), (byte) 103);
						...
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(client.anInt8836 * 392084321);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(1408085039 * client.usedId, 249731045);
				...
				if (25 == i_34_) {
					...
					if (class105 != null) {
						...
						client.aString8754 = new StringBuilder().append(class105.aString1228)
					...
					if (15 == i_34_) { // widget on nonself player
						...
						if (null != player) {
							...
							client.anInt8786 = 0;
							Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.INTERFACE_ON_PLAYER,
									(client.aClass25_8711.aClass449_330), (byte) 92);
							class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(client.usedId * 1408085039, 16711935);
					...
					if (i_34_ == 60) {
						if (client.playerRights * 1806357379 > 0 && Class434.method5802(838408640))
							...
							Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2082,
									(client.aClass25_8711.aClass449_330), (byte) 98);
