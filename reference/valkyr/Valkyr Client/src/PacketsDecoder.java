...
public class PacketsDecoder {
	...
	static final boolean method4548(Class25 class25, int i) throws IOException {
		try {
			...
			if (IncommingPacket.aClass202_2218 == ((Class25) class25).INCOMMING_PACKET) {
				int i_17_ = stream.readUnsignedShort();
				Class240_Sub1.i_8120_ = i_17_;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.GRAPHICS_PACKET) {
				...
				if (targetHash >> 30 != 0) {
					...
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) client.aClass437_8696.get((long) i_107_));
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2236) {
				...
				if (i_157_ != -1) {
					client.aClass299Array8671[i_156_] = new Class299(Class373.activeToolkit, stream, i_157_);
			...
			if (IncommingPacket.CUTSCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class399.idx35.fileLoaded(577335585 * client.anInt8870, -457216440);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2154) {// emote
				...
				Class298_Sub29 class298_sub29 = ((Class298_Sub29) client.aClass437_8696.get((long) i_425_));
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.CLOSE_INTERFACE_PACKET) {
				...
				Interface class298_sub51 = ((Interface) client.aClass437_8841.get((long) interfaceHash));
				if (class298_sub51 != null)
