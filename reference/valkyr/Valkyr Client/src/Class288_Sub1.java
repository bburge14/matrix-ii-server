...
public class Class288_Sub1 extends Class288 implements Runnable {
	...
	try {
		...
		try {
			...
			client.aClass25_8693.method389((Class264_Sub4.method2515(Class241.aClass471_2705.craeteSocket(true), 15000, -649048480)), Class241.aClass471_2705.address, (byte) 0);
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(client.gametype.gameType * -937307905);
