...
public class Class251 {
	...
	try {
	    ...
	    client.anInt8857 = 0;
	    client.anInt8852 = ((((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]) * -2045228877);
	    client.anInt8774 = (-546154255 * (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]));
	...
	try {
		...
		Sprite class57 = (Class82_Sub11.aClass57Array6861[client.anInt8786 * 1347929875 / 100]);
		class57.method645(i_8_ - 8, i_9_ - 8);
	    }
	    if (2 == client.anInt8748 * -392325587) {
		Sprite class57 = (Class82_Sub11.aClass57Array6861[4 + client.anInt8786 * 1347929875 / 100]);
		class57.method645(i_8_ - 8, i_9_ - 8);
	    }
	}
	catch (RuntimeException runtimeexception) {
