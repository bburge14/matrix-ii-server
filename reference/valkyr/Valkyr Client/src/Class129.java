...
public class Class129 implements Interface6 {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.isMemberWorld ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (client.aClass25_8711.method387(537308016) != null && ObjectOverride.method5804(client.anInt8752 * -1233866115, (byte) 76))
