...
public class GraphicDefinition {
	...
	static final void method4923(int i, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_,
			int i_29_) {
		try {
			if (i_23_ >= 1 && i_24_ >= 1 && i_23_ <= client.aClass283_8716.method2629(-1936425983) - 2
				...
				if (client.aClass283_8716.method2675(-1611682495) != null) {
					client.aClass283_8716.method2644(-1368274969).method2234(Class373.activeToolkit, i, i_22_, i_23_, i_24_,
							client.aClass283_8716.getSceneClipDataPlane(i), 366084983);
					if (i_25_ >= 0) {
						...
						client.aClass283_8716.method2644(-630573167).method2243(Class373.activeToolkit, i_30_, i, i_23_,
								i_24_, i_25_, i_26_, i_27_, client.aClass283_8716.getSceneClipDataPlane(i), i_28_,
								2073430416);
