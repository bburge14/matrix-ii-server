	...
	try {
		...
		if ((-1054937867 * client.anInt8941 >= 200 && !client.aBoolean8807) || -1054937867 * client.anInt8941 >= 200)
			...
			for (int i_1_ = 0; i_1_ < client.anInt8941 * -1054937867; i_1_++) {
			    String string_2_ = BillBoardDefinitions.method1824((client.aStringArray8704[i_1_]), 460678269);
				...
				String string_3_ = BillBoardDefinitions.method1824((client.aStringArray8945[i_1_]), -1697709934);
			...
			for (int i_4_ = 0; i_4_ < -548972447 * client.anInt8952; i_4_++) {
			    String string_5_ = BillBoardDefinitions.method1824((client.aStringArray8859[i_4_]), 629913933);
				...
				String string_6_ = BillBoardDefinitions.method1824((client.aStringArray8955[i_4_]), -1007795446);
