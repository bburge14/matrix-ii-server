...
public class Class176 {
	...
	void method1827(AbstractToolkit DXToolkit) {
	...
	void method1829_cp(DXToolkit DXToolkit, Class69 class69, cat ccat, int ci, int ca) {
		DXToolkit.RA(false);
		aFloat1786 = DXToolkit.aFloat8291;
		float f = DXToolkit.aClass233_8230.aFloatArray2594[2];
		float f_0_ = DXToolkit.aClass233_8230.aFloatArray2594[6];
		float f_1_ = DXToolkit.aClass233_8230.aFloatArray2594[10];
		float f_2_ = DXToolkit.aClass233_8230.aFloatArray2594[14];
		int i = 0;
		int i_3_ = 2147483647;
		int i_4_ = 0;
		...
		i = 0;
		DXToolkit.method5384(((Class176) this).anInterface7_Impl2_1778);
		Class130 class130 = ((DXToolkit) DXToolkit).aClass130_8249;
		...
		while (class302_sub3_9_ != class302_sub3) {
			...
			//class130.anInterface9_Impl2_1492 = ((DXToolkit) DXToolkit).aClass157_8351.method1698(i_10_ >= 0 ? i_10_ : -1);
			if (bool && DXToolkit.aFloat8291 != aFloat1786)
				DXToolkit.IA(aFloat1786);
			else if (DXToolkit.aFloat8291 != 1.0F)
				DXToolkit.IA(1.0F);
			method1830_cp(DXToolkit, i_7_, ccat, ci, ca);
		}
		if (DXToolkit.aFloat8291 != aFloat1786)
			DXToolkit.IA(aFloat1786);
		DXToolkit.RA(true);
	}

	void method1830_cp(DXToolkit DXToolkit, int i, cat ccat, int ci, int ca) {
		int i_15_ = 0;
		Class233 class233 = DXToolkit.aClass233_8230;
		...
		ByteBuffer bytebuffer = DXToolkit.aByteBuffer8216;
		bytebuffer.clear();
		for (int i_30_ = i - 1; i_30_ >= 0; i_30_--) {
			...
			if (i_31_ > 0) {
				for (int i_32_ = i_31_ - 1; i_32_ >= 0; i_32_--) {
					...
					// << Position offsets?
					if (((DXToolkit) DXToolkit).anInt8346 == 0) {
		...
		((Class176) this).anInterface7_Impl1_1773.method63(0, bytebuffer
				.position(), DXToolkit.aLong8217);
		DXToolkit.method5383(0, ((Class176) this).anInterface7_Impl1_1773);
		DXToolkit.method5383(1, ((Class176) this).anInterface7_Impl1_1771);
		DXToolkit.method5455(((Class176) this).aClass153_1774);
		Class130 class130 = ((DXToolkit) DXToolkit).aClass130_8249;
		class130.method1450(i_15_);
	}

	void method1829(AbstractToolkit DXToolkit, Class69 class69) {
		DXToolkit.RA(false);
		aFloat1786 = DXToolkit.aFloat8291;
		float f = DXToolkit.aClass233_8230.aFloatArray2594[2];
		float f_0_ = DXToolkit.aClass233_8230.aFloatArray2594[6];
		...
		i = 0;
		DXToolkit.method5384(((Class176) this).anInterface7_Impl2_1778);
		Class130 class130 = ((AbstractToolkit) DXToolkit).aClass130_8249;
		class130.method1452(Class233.aClass233_2595);
		class130.aClass233_1494.method2172();
		class130.anInt1493 = -1;
		int i_10_ = -2;
		...
		while (class302_sub3_9_ != class302_sub3) {
			...
			if (i_10_ >= 0) {
				TextureMetrics class53 = DXToolkit.anInterface_ma5299.getTexture(i_10_, 0);
				if (class53.textureId != -1)
					class130.anInterface9_Impl2_1492 = DXToolkit.aClass157_8351.method1698(class53);
				DXToolkit.method9662(class53.blendMode);
			}
			if (bool && DXToolkit.aFloat8291 != aFloat1786)
				DXToolkit.IA(aFloat1786);
			else if (DXToolkit.aFloat8291 != 1.0F)
				DXToolkit.IA(1.0F);
			method1830(DXToolkit, i_7_);
		}
		if (DXToolkit.aFloat8291 != aFloat1786)
			DXToolkit.IA(aFloat1786);
		DXToolkit.RA(true);
	...
	void method1830(AbstractToolkit DXToolkit, int i) {
		int i_15_ = 0;
		Class233 class233 = DXToolkit.aClass233_8230;
		float f = class233.aFloatArray2594[0];
		float f_16_ = class233.aFloatArray2594[4];
		...
		for (int i_30_ = i - 1; i_30_ >= 0; i_30_--) {
			...
			if (i_31_ > 0) {
				for (int i_32_ = i_31_ - 1; i_32_ >= 0; i_32_--) {
					...
					bytebuffer.putFloat(f_39_ + f_22_ * (float) -i_41_);
					bytebuffer.putFloat(f_40_ + f_23_ * (float) -i_41_);
					if (((AbstractToolkit) DXToolkit).anInt8346 == 0) {
						bytebuffer.put(i_36_);
						bytebuffer.put(i_35_);
						bytebuffer.put(i_34_);
						bytebuffer.put(i_37_);
		...
		((Class176) this).anInterface7_Impl1_1773.method63(0, bytebuffer.position(), DXToolkit.aLong8217);
		DXToolkit.method5383(0, ((Class176) this).anInterface7_Impl1_1773);
		DXToolkit.method5383(1, ((Class176) this).anInterface7_Impl1_1771);
		DXToolkit.method5455(((Class176) this).aClass153_1774);
		Class130 class130 = ((AbstractToolkit) DXToolkit).aClass130_8249;
	...
	Class176(AbstractToolkit DXToolkit) {
		...
		((Class176) this).anInt1777 = 0;
		((Class176) this).aClass153_1774 = (DXToolkit.method5404(new Class181[] {
				new Class181(
						new Class155[] { Class155.aClass155_1610, Class155.aClass155_1597, Class155.aClass155_1599 }),
				new Class181(Class155.aClass155_1596) }));
		((Class176) this).anInterface7_Impl1_1773 = DXToolkit.method5382(true);
		((Class176) this).anInterface7_Impl1_1771 = DXToolkit.method5382(false);
		((Class176) this).anInterface7_Impl1_1771.method72(393168, 12);
		((Class176) this).anInterface7_Impl2_1778 = DXToolkit.method5381(false);
		...
		((Class176) this).anInterface7_Impl2_1778.method63(0, bytebuffer.position(), DXToolkit.aLong8217);
		bytebuffer.clear();
		for (int i = 0; i < 8191; i++) {
			bytebuffer.putFloat(0.0F);
			bytebuffer.putFloat(-1.0F);
		...
		((Class176) this).anInterface7_Impl1_1771.method63(0, bytebuffer.position(), DXToolkit.aLong8217);
	}
}
