...
public abstract class Toolkit {
	...
	public abstract void method5042_cp(Class69 class69, cat ccat, int ci, int ca);
	...
	static void method5192(int i, int i_484_, int i_485_, int i_486_, int i_487_, int i_488_, int i_489_,
		...
		try {
			...
			class264.method2480(string, 3 + i_485_, i_489_, i_490_, 0, client.aRandom8702, Class368.anInt4005 * 1401020893,
			...
			if (null != class117) {
				...
				if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285
					...
					for (int i_509_ = 0; i_509_ < 1659101557 * Class3.anInt67; i_509_++) {
						...
						ObjectDefinitions class432 = (client.aClass283_8716.method2641(2011176396)
					...
					for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) client.aClass437_8685.method5816(
							1742338274)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) client.aClass437_8685
									.method5815((byte) 24))) {
