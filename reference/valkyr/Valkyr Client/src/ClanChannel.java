...
public class ClanChannel extends Class298 {
    ...
    void method3096(ClanChatUser class163, int i) {
	try {
	...
	try {
		...
		members = new ClanChatUser[649879491 * anInt7356];
		for (int i_3_ = 0; i_3_ < anInt7356 * 649879491; i_3_++) {
		    ClanChatUser class163 = new ClanChatUser();
	...
	try {
	    if (null != members)
		Class425.arrayCopy(members, 0, members = new ClanChatUser[i], 0, anInt7356 * 649879491);
	    else
		members = new ClanChatUser[i];
	}
	catch (RuntimeException runtimeexception) {
