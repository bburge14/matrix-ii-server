...
//	    throw Class346.method4175(runtimeexception, new StringBuilder().append("g.d(").append(')').toString());
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8665 * -1154804873;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8680 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
