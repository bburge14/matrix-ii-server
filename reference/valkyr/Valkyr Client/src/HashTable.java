		...
		try {
			if (i_9_ != 0 && -1 != i_11_) {
				...
				if (i_9_ < 0) {
					...
					int i_24_ = i_9_ - 1;
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) client.aClass437_8696.get((long) i_24_));
			...
			Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(
					client.aClass283_8716.method2675(-1611682495), i, Class375.basePlane * -191892109,
					Class375.basePlane * -191892109, i_14_, i_15_, i_12_, client.ticketCycle * 443738891 + i_18_,
					client.ticketCycle * 443738891 + i_19_, i_20_, i_21_, i_9_, i_10_, i_13_, bool, i_11_));
			class365_sub1_sub1_sub1.method4405(i_16_, i_17_,
					...
					443738891 * client.ticketCycle + i_18_, 1068285759);
