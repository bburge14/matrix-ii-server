...
final class Class93 implements Interface23 {
	...
	try {
		...
		((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class227.method2114(client.aString8804, 864183945);
	    else
	...
	try {
	    if (!ObjectOverride.method5804(client.anInt8752 * -1233866115, (byte) -26))
