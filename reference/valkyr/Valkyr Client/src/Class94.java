...
public final class Class94 {
	...
	try {
		...
		if (1762367763 * anInt909 >= 0) {
		    ...
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10075 = client.ticketCycle * -128551287;
		    ...
		    ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287 * client.ticketCycle;
	...
	try {
		...
		((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 1806357379 * client.playerRights;
	    else
	...
	try {
		...
		if (i_12_ == 0) {
		    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = client.WINDOW_PANE_ID * -257444687;
		    return;
		}
		i_12_--;
	    }
