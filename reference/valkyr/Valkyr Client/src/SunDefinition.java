...
public class SunDefinition {
		...
		try {
			if (bool) {
				Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2036,
						client.aClass25_8711.aClass449_330, (byte) 105);
	...
	static final void method1400(int i, int i_12_, int i_13_, int i_14_, int i_15_, boolean bool, int i_16_) {
		try {
			if (!bool && (i_12_ < 512 || i_13_ < 512 || i_12_ > (client.aClass283_8716.method2629(-2030738775) - 2) * 512
					|| i_13_ > (client.aClass283_8716.method2630(346597058) - 2) * 512)) {
				float[] fs = client.aFloatArray8891;
				client.aFloatArray8891[1] = -1.0F;
				fs[0] = -1.0F;
			} else {
				int i_17_ = (Class356.method4271(i_12_, i_13_, i, -1332954611) - i_15_);
				client.aClass222_8871.method2070(Class373.activeToolkit.method5044());
				client.aClass222_8871.method2064((float) i_14_, 0.0F, 0.0F);
				Class373.activeToolkit.method5043(client.aClass222_8871);
				if (bool)
					Class373.activeToolkit.method5060((float) i_12_, (float) i_17_, (float) i_13_, client.aFloatArray8891);
				else
					Class373.activeToolkit.method5059((float) i_12_, (float) i_17_, (float) i_13_, client.aFloatArray8891);
				client.aClass222_8871.method2064((float) -i_14_, 0.0F, 0.0F);
				Class373.activeToolkit.method5043(client.aClass222_8871);
		...
		try {
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub27_7579.method5720((byte) -102) == 0) {
				for (int i_18_ = 0; i_18_ < client.anInt8894 * 1351936279; i_18_++) {
					if (client.anInterface16Array8710[i_18_].method217((byte) -58) == 's'
							|| client.anInterface16Array8710[i_18_].method217((byte) -73) == 'S') {
			...
			if (Class227.aClass227_2537 == Class82_Sub6.aClass227_6843) {
				...
				Class94.aClass349_913 = new Class349(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						EquipmentDefaults.aClass405_6892);
				Shadow.aClass491_9686 = new Class491(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						Class158.idx8);
				...
				Class500.aClass347_6117 = new Class347(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						Class158.idx8);
				Class212.aClass144_2433 = new Class144(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						WorldTile.idx7);
				...
				Class463.aClass433_5689 = new Class433(client.gametype, Class321.aClass429_3357, true, Class354.idx16,
						WorldTile.idx7);
				client.aClass283_8716.method2645(Class463.aClass433_5689, -18361497);
				Class62.aClass248_612.method2379(
						new Class433(client.gametype, Class321.aClass429_3357, true, Class354.idx16, WorldTile.idx7),
						681479919);
				Class363.aClass339_3931 = new Class339(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						Class158.idx8);
				ConfigEntry.aClass487_1463 = new Class487(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2,
						Class158.idx8);
				Class15.aClass507_224 = new Class507(client.gametype, Class321.aClass429_3357, true, Class133.idx18,
						WorldTile.idx7);
				Class298_Sub32_Sub14.aClass477_9400 = new Class477(client.gametype, Class321.aClass429_3357, true,
				...
				Class501.aClass395_6122 = new Class395(client.gametype, Class321.aClass429_3357, Class260.idx20,
						Class491.idx0, Class497.idx1);
				ConfigDefinitions.aClass317_3472 = new Class317(client.gametype, Class321.aClass429_3357,
						Class284_Sub1.idx2);
				Class138_Sub1.aClass131_7010 = new Class131(client.gametype, Class321.aClass429_3357, Class284_Sub1.idx2);
				Class158_Sub1.aClass389_8568 = new Class389(client.gametype, Class321.aClass429_3357, Class23.idx21,
						WorldTile.idx7);
			...
			if (Class227.aClass227_2542 == Class82_Sub6.aClass227_6843)
				Class301.method3690(Class_v.idx23, Class504.aClass375_6196, Class151.aClass451_6358,
						client.aClass283_8716.method2641(-1404290651), Class363.aClass339_3931, ConfigEntry.aClass487_1463,
