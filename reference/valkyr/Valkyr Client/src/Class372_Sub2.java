...
public class Class372_Sub2 extends Class372 {
	...
	try {
	    ...
	    client.aShort8839 = (short) (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
	    if (client.aShort8839 <= 0)
		client.aShort8839 = (short) 1;
	    client.aShort8743 = (short) (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]);
	    ...
	    client.aShort8934 = (short) (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 + 2]);
	    if (client.aShort8934 <= 0)
		client.aShort8934 = (short) 1;
	    client.aShort8935 = (short) (((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]);
