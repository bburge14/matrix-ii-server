	...
	try {
		...
		if (10 == Class301_Sub1.anInt7624 * -1289394455) {
			...
			if (!Class301_Sub1.idx23.method2312(new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -2145213052))
			    return;
			Class301_Sub1.aClass296_3235 = (WorldMap.getMapKeys(Class301_Sub1.idx23, new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), client.isMemberWorld, 565671699));
		    } else
