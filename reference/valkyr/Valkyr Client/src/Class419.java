		...
		try {
			do {
				try {
					...
					else if (string.equalsIgnoreCase("toggle_night")) {
						client.primaryNight = !client.primaryNight;
						if (client.primaryNight)
							Class240_Sub1.i_8120_ = 9;
						else 
							Class240_Sub1.i_8120_ = 9;
						Class255.method2435("Transitioning Skybox...", 899052076);
						method5605("lmstest", true, false, 0);
					}
