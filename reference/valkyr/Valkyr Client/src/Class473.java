	...
	try {
		...
		if (-1 != -967533709 * (class365_sub1_sub1_sub2.currentGraphics[i_2_].id)) {
			...
			if (class398.aBoolean5215) {
			    ...
			    } else if (1 == class391.animatingPrecedence * 62820525 && (class365_sub1_sub1_sub2.anInt10125 * 1888275831) > 0 && ((-412225079 * (class365_sub1_sub1_sub2.anInt10095)) <= 443738891 * client.ticketCycle) && ((1450943713 * (class365_sub1_sub1_sub2.anInt10103)) < 443738891 * client.ticketCycle)) {
				if (i <= 0)
				    throw new IllegalStateException();
				continue;
			    }
