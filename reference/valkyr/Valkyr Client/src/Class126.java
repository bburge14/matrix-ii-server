...
public class Class126 implements Interface6 {
	...
	try {
		...
		if (client.anInt8752 * -1233866115 == 0) {
			...
			Ground.aClass396_6291 = client.aClass404_8715.method4946((Class474.aClass471_5979.address), (byte) 25);
			...
			if ((((Class25) client.aClass25_8711).anInt338 * 1237236843) > 2250)
			    ...
			    if (client.playerRights * 1806357379 > 0 && Class372.aClass323_4052.pressingKey(82, -510265259) && Class372.aClass323_4052.pressingKey(81, 1722713678) && client.mouseWheelScroll * 1170859143 != 0) {
				int i_14_ = ((Class287.myPlayer.plane) - client.mouseWheelScroll * 1170859143);
				if (i_14_ < 0)
				    i_14_ = 0;
				else if (i_14_ > 3)
				    i_14_ = 3;
				...
				Class476.method6083(i_14_, ((Class287.myPlayer.scenePositionXQueue[0]) + -1760580017 * class341.x), ((Class287.myPlayer.scenePositionYQueue[0]) + 283514611 * class341.y), 1979698840);
			    } else if (Class372.aClass323_4052.pressingKey(81, -510265259) && client.mouseWheelScroll * 1170859143 != 0) {
			    	int scrollDir = (client.mouseWheelScroll * 1170859143) * -10;
					...
					System.out.println(zoom - scrollDir + ", " + scrollDir);
	...
	try {
	    ...
	    Integer integer = (((Class403) class403).aClass162_5252.method1753(client.gametype.gameType * -937307905 << 16 | i_18_, (byte) -31));
	    int i_19_;
	    if (integer == null) {
