...
public class Class356 {
	...
	try {
		...
		i_9_++;
	    return client.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_9_].averageHeight(i, i_4_, -1909964281);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8643 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
