		...
		if (class105 == null) {
			...
			if (i_17_ < i_19_) {
				...
				if (-1215239439 * class105.type == 0) {
				    ...
				    Interface class298_sub51 = ((Interface) (client.aClass437_8841.get((long) (class105.ihash * -440872681))));
					...
					if (0 == 1596783995 * client.anInt8724) {
						...
						float f = ((float) (((client.ticketCycle) * 443738891) - (1757243277 * (client.anInt8728))) * 1.0F / (float) (((client.anInt8737) * -230034171) - ((client.anInt8728) * 1757243277)));
				...
				if (!client.aBooleanArray8901[i_11_] && client.anInt8956 * 2067224717 <= 1) {
					...
					class105.method1114(Class373.activeToolkit, class387, client.aClass222_8968, 443738891 * client.ticketCycle, 1739448532);
					if (client.aBoolean8849)
