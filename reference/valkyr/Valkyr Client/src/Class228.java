...
public class Class228 {
	...
	try {
		...
		if (class336.method4090(2, i_10_, i_11_, class289, -16711936)) {
		    ...
		    ClanChatUser.anInt1684 = -575994451 * i_11_;
		    return true;
		}
	...
	try {
		...
		int i_25_ = ClanChatUser.method1773(string.charAt(i_24_), -40024446);
		int i_26_ = (i_24_ + 1 < i_23_ ? ClanChatUser.method1773(string.charAt(1 + i_24_), 1761771208) : -1);
		int i_27_ = (2 + i_24_ < i_23_ ? ClanChatUser.method1773(string.charAt(2 + i_24_), 623747518) : -1);
		int i_28_ = (i_24_ + 3 < i_23_ ? ClanChatUser.method1773(string.charAt(i_24_ + 3), 1229588136) : -1);
