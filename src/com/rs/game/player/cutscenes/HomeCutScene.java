...
public class HomeCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(final Player player) {
		...
		actionsList.add(new NPCForceTalkAction(GUARD1, "Let's just take him to Brad's Playground...", 2));
		...
		actionsList.add(new PlayerForceTalkAction("What\'s Brad's Playground?", 0));
		...
		actionsList.add(new CutsceneCodeAction(new Runnable() {
			@Override
			public void run() {
				player.getDialogueManager().startDialogue("SimpleNPCMessage", 15158, "Welcome to Brad's Playground!", "If you have any questions make sure to read the guide book in your inventory.");
