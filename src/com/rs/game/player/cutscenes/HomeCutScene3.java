...
public class HomeCutScene3 extends Cutscene {
	...
	public CutsceneAction[] getActions(final Player player) {
		 ...
		 */
		actionsList.add(new CreateNPCAction(ADVERTISER, 15786, 3448, 3707, 0, "Brad's Playground Welcomer", 0, -1));
		...
		actionsList.add(new NPCForceTalkAction(ADVERTISER, player.getDisplayName() + " has arrived at Brad's Playground!", 3));
		...
		actionsList.add(new NPCForceTalkAction(ORACLE, "Allow me to show you the world of Brad's Playground.", 3));
		...
		actionsList.add(new NPCForceTalkAction(ORACLE, "Brad's Playground has many beasts (beast players too) aswell.", 5));
		...
		public void run() {
			...
			//player.getDialogueManager().startDialogue("SimpleNPCMessage", 15158, "Welcome to Brad's Playground!", "If you have any questions make sure to read guide book in your inventory.");
