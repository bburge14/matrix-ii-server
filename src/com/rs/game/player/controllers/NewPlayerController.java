...
public class NewPlayerController extends Controller {
	...
	public boolean login() {
		// Don't replay cutscene on every login — just remove the controller.
		// If we want first-time intro, it happens when controller is first assigned at account creation.
		return true;
	}
