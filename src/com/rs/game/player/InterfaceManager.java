...
public class InterfaceManager {
	...
	public void unlockSubscribe() {
		// Donate button removed — hide both the subscribe container and the donate button itself
		player.getPackets().sendHideIComponent(1484, 0, true);
		player.getPackets().sendHideIComponent(1484, 7, true);
	}
	...
	public void openMenu(int menu, int subMenu) {
		...
		if (menu == 0) { //hero
			...
			}else if (subMenu == 5) { //twitch (or admin panel for staff)
