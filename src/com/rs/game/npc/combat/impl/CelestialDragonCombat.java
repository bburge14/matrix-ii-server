...
public class CelestialDragonCombat extends CombatScript {

	@Override
	public Object[] getKeys() {
		return new Object[] { "Celestial dragon" };
	}
	...
	public int attack(NPC npc, Entity target) {
		...
		case 0:
			if (npc.withinDistance(target, 3)) {
				damage = getMaxHit(npc, npc.getMaxHit(NPCCombatDefinitions.MELEE),
