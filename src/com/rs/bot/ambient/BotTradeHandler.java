...
public final class BotTradeHandler {
    ...
    private static final StockEntry[] CATALOG_SKILL = new StockEntry[] {
        ...
        new StockEntry(6332, 2500,   "teak logs",    100),
        new StockEntry(6333, 3000,   "mahogany logs", 100),
        // Ores
        ...
        // Bars
        new StockEntry(2351, 200,    "bronze bar",   100),
        new StockEntry(2353, 300,    "iron bar",     100),
        new StockEntry(2355, 500,    "steel bar",    100),
        new StockEntry(2357, 700,    "gold bar",     50),
        new StockEntry(2359, 1100,   "mithril bar",  50),
        new StockEntry(2361, 2200,   "adamantite bar", 25),
        new StockEntry(2363, 14000,  "runite bar",   10),
        // Raw + cooked fish
        ...
        new StockEntry(7944, 1300,   "monkfish",     50),
        new StockEntry(15272,2200,   "rocktail",     25),
        // Runes
        ...
        new StockEntry(558,  30,     "mind runes",   500),
        new StockEntry(559,  60,     "body runes",   500),
        new StockEntry(560,  300,    "death runes",  100),
        new StockEntry(561,  150,    "nature runes", 100),
        new StockEntry(562,  150,    "chaos runes",  100),
        new StockEntry(563,  100,    "law runes",    100),
        new StockEntry(564,  120,    "cosmic runes", 100),
        new StockEntry(565,  250,    "blood runes",  100),
        new StockEntry(566,  500,    "soul runes",    50),
        new StockEntry(9075, 50,     "astral runes", 500),
        // Bones (Prayer)
        new StockEntry(526,  50,     "bones",        100),
        new StockEntry(532,  150,    "big bones",    100),
        new StockEntry(536,  3500,   "dragon bones", 25),
        new StockEntry(11620,8000,   "frost dragon bones", 25),
        new StockEntry(592,  150,    "ashes",        100),
        // Herbs
        new StockEntry(199,  100,    "grimy guam",   50),
        new StockEntry(201,  300,    "grimy marrentill", 50),
        new StockEntry(203,  500,    "grimy tarromin", 50),
        new StockEntry(205,  900,    "grimy harralander", 50),
        new StockEntry(207,  4000,   "grimy ranarr", 25),
        new StockEntry(209,  2500,   "grimy irit",   25),
        new StockEntry(211,  3500,   "grimy avantoe", 25),
        new StockEntry(213,  2500,   "grimy kwuarm", 25),
        new StockEntry(215,  4500,   "grimy cadantine", 25),
        new StockEntry(217,  6000,   "grimy lantadyme", 25),
        new StockEntry(219,  9000,   "grimy torstol", 10),
        new StockEntry(3049, 12000,  "grimy fellstalk", 10),
        // Potions
        new StockEntry(2436, 1500,   "attack potion(4)", 25),
        new StockEntry(2440, 2500,   "strength potion(4)", 25),
        new StockEntry(2442, 3500,   "defence potion(4)", 25),
        new StockEntry(2444, 1500,   "ranging potion(4)", 25),
        new StockEntry(3040, 3500,   "magic potion(4)", 25),
        new StockEntry(2434, 6000,   "prayer potion(4)", 25),
        new StockEntry(15300,12000,  "super restore(4)", 25),
        new StockEntry(15308,8000,   "super energy(4)", 25),
        new StockEntry(2432, 4500,   "super attack(4)", 25),
        new StockEntry(2436, 4500,   "super strength(4)", 25),
        new StockEntry(2438, 5500,   "super defence(4)", 25),
        new StockEntry(15332,10000,  "saradomin brew(4)", 25),
        new StockEntry(2452, 12000,  "antifire(4)",  25),
        // Gems
        new StockEntry(1623, 400,    "uncut sapphire", 25),
        new StockEntry(1621, 800,    "uncut emerald", 25),
        new StockEntry(1619, 1000,   "uncut ruby",   25),
        new StockEntry(1617, 2500,   "uncut diamond", 10),
        new StockEntry(1631, 12000,  "uncut dragonstone", 5),
        new StockEntry(6571, 30000,  "uncut onyx",    1),
        // Arrows / ammo (consumables - bulk)
        new StockEntry(882,  10,     "bronze arrows", 500),
        ...
        new StockEntry(11212,1500,   "dragon arrows", 100),
        // Dragonhides + leather
        new StockEntry(1739, 100,    "cowhide",      100),
        new StockEntry(1741, 100,    "leather",      100),
        new StockEntry(1745, 700,    "hard leather", 100),
        new StockEntry(1747, 1500,   "green dragonhide", 50),
        new StockEntry(1749, 2500,   "blue dragonhide",  50),
        new StockEntry(1751, 3500,   "red dragonhide",   50),
        new StockEntry(1753, 5000,   "black dragonhide", 50),
        // Misc skilling
        new StockEntry(314,  10,     "feather",      500),
        new StockEntry(1777, 50,     "bowstring",    100),
        new StockEntry(1734, 30,     "thread",       500),
        new StockEntry(1765, 20,     "ball of wool", 100),
        new StockEntry(2347, 25,     "hammer",        25),
        new StockEntry(1592, 500,    "ring mould",     5),
        new StockEntry(1755, 25,     "chisel",        25),
        new StockEntry(946,  10,     "knife",         50),
        new StockEntry(2966, 250,    "pestle and mortar", 10),
        new StockEntry(8794, 200,    "saw",           25),
        new StockEntry(952,  25,     "spade",         25),
        new StockEntry(5341, 30,     "rake",          25),
        new StockEntry(5343, 35,     "secateurs",     25),
    };
    ...
    private static final StockEntry[] CATALOG_COMBAT = new StockEntry[] {
        ...
        new StockEntry(11235,150_000,   "dark bow",       1),
        new StockEntry(13883,200_000,   "morrigan's javelin", 50),
        new StockEntry(13955,80_000,    "dragon claws",   1),
        new StockEntry(1249, 60_000,    "dragon spear",   1),
        new StockEntry(3204, 70_000,    "dragon halberd", 1),
        new StockEntry(4151, 150_000,   "abyssal whip", 1),
        new StockEntry(15441,500_000,   "abyssal vine whip", 1),
        new StockEntry(861,  600,       "magic shortbow", 1),
        new StockEntry(859,  500,       "magic longbow", 1),
        new StockEntry(15701,2_000_000, "chaotic rapier", 1),
        new StockEntry(15703,2_000_000, "chaotic longsword", 1),
        new StockEntry(18353,2_500_000, "chaotic maul",    1),
        new StockEntry(18357,2_500_000, "chaotic crossbow",1),
        new StockEntry(18355,3_000_000, "chaotic staff",   1),
        // Rune armor (singles)
        ...
        new StockEntry(1093, 25_000,    "rune plateskirt",1),
        ...
        new StockEntry(14479, 800_000,  "dragon platebody", 1),
        new StockEntry(4087,  120_000,  "dragon platelegs", 1),
        new StockEntry(4585,  120_000,  "dragon plateskirt",1),
        new StockEntry(1377,   80_000,  "dragon chain",    1),
        // Mage stuff
        new StockEntry(1389, 8_000,     "mystic staff", 1),
        new StockEntry(1391, 5_000,     "staff of air",  1),
        new StockEntry(6914, 80_000,    "master wand", 1),
        new StockEntry(6889, 30_000,    "mage's book",  1),
        new StockEntry(2412, 70_000,    "saradomin staff", 1),
        new StockEntry(2415, 70_000,    "zamorak staff",   1),
        new StockEntry(2417, 70_000,    "guthix staff",    1),
        ...
        new StockEntry(4089, 25_000,    "mystic hat (blue)", 1),
        new StockEntry(4091, 35_000,    "mystic robe top (blue)", 1),
        new StockEntry(4093, 30_000,    "mystic robe legs (blue)", 1),
        new StockEntry(4099, 25_000,    "mystic hat (dark)", 1),
        new StockEntry(4101, 35_000,    "mystic robe top (dark)", 1),
        new StockEntry(4103, 30_000,    "mystic robe legs (dark)", 1),
        new StockEntry(4109, 25_000,    "mystic hat (light)", 1),
        new StockEntry(4111, 35_000,    "mystic robe top (light)", 1),
        new StockEntry(4113, 30_000,    "mystic robe legs (light)", 1),
        // Barrows armor sets
        new StockEntry(4708, 800_000,   "ahrim's hood",      1),
        new StockEntry(4712, 1_200_000, "ahrim's robetop",   1),
        new StockEntry(4714, 800_000,   "ahrim's robeskirt", 1),
        new StockEntry(4716, 600_000,   "dharok's helm",     1),
        new StockEntry(4720, 1_500_000, "dharok's platebody",1),
        new StockEntry(4722, 1_200_000, "dharok's platelegs",1),
        new StockEntry(4718, 1_400_000, "dharok's greataxe", 1),
        new StockEntry(4724, 700_000,   "guthan's helm",     1),
        new StockEntry(4728, 1_300_000, "guthan's platebody",1),
        new StockEntry(4730, 1_000_000, "guthan's chainskirt", 1),
        new StockEntry(4726, 1_100_000, "guthan's warspear", 1),
        new StockEntry(4732, 700_000,   "karil's coif",      1),
        new StockEntry(4736, 1_300_000, "karil's leathertop",1),
        new StockEntry(4738, 1_000_000, "karil's leatherskirt", 1),
        new StockEntry(4734, 80_000,    "karil's crossbow",  1),
        new StockEntry(4745, 600_000,   "torag's helm",      1),
        new StockEntry(4749, 1_200_000, "torag's platebody", 1),
        new StockEntry(4751, 900_000,   "torag's platelegs", 1),
        new StockEntry(4747, 800_000,   "torag's hammers",   1),
        new StockEntry(4753, 600_000,   "verac's helm",      1),
        new StockEntry(4757, 1_200_000, "verac's brassard",  1),
        new StockEntry(4759, 900_000,   "verac's plateskirt", 1),
        new StockEntry(4755, 800_000,   "verac's flail",     1),
        // Slayer helms / black mask
        new StockEntry(8901, 200_000,   "slayer helmet",     1),
        new StockEntry(15492,400_000,   "full slayer helmet",1),
        new StockEntry(8921, 50_000,    "broad arrows",     500),
        // Amulets / jewelry
        new StockEntry(1712, 12_000,    "amulet of glory(4)", 1),
        new StockEntry(1725, 4_000,     "amulet of strength", 1),
        new StockEntry(1727, 1_500,     "amulet of magic",    1),
        new StockEntry(1729, 1_500,     "amulet of defence",  1),
        ...
        new StockEntry(11118, 30_000,   "combat bracelet(4)", 1),
        new StockEntry(2552,  3_000,    "ring of dueling(8)", 1),
        new StockEntry(11978, 30_000,   "amulet of glory(t)", 1),
        // Range
        new StockEntry(11212, 1_500,    "dragon arrows", 100),
        new StockEntry(13083, 70_000,   "armadyl crossbow", 1),
        new StockEntry(861,   600,      "magic shortbow",   1),
        // Boots / gloves
        new StockEntry(11732, 60_000,   "dragon boots",  1),
        new StockEntry(2577,  25_000,   "ranger boots",  1),
        new StockEntry(7462,  650,      "barrows gloves", 1),
        new StockEntry(2491,  3_000,    "blue d'hide body",1),
        new StockEntry(2497,  4_000,    "red d'hide body", 1),
        new StockEntry(2503,  6_500,    "black d'hide body", 1),
    ...
    private static final StockEntry[] CATALOG_RARE = new StockEntry[] {
        ...
        new StockEntry(1052, 180_000_000, "cape of legends", 1),
        new StockEntry(4084, 100_000_000, "yo-yo",            1),
        // Third Age - tradeable rare drops from clue scrolls
        new StockEntry(10330, 500_000_000, "third age full helmet", 1),
        new StockEntry(10332, 600_000_000, "third age platebody",  1),
        new StockEntry(10334, 500_000_000, "third age platelegs",  1),
        new StockEntry(10336, 400_000_000, "third age kiteshield", 1),
        new StockEntry(10342, 500_000_000, "third age range coif", 1),
        new StockEntry(10344, 600_000_000, "third age range top",  1),
        new StockEntry(10346, 500_000_000, "third age range legs", 1),
        new StockEntry(10350, 700_000_000, "third age longsword",  1),
        new StockEntry(10352, 800_000_000, "third age bow",        1),
        new StockEntry(19308, 1_000_000_000, "third age druidic staff", 1),
        // Spirit shields (tradeable, very expensive)
        new StockEntry(13738, 250_000_000, "arcane spirit shield", 1),
        new StockEntry(13740, 200_000_000, "divine spirit shield", 1),
        new StockEntry(13742, 400_000_000, "elysian spirit shield", 1),
        new StockEntry(13744, 150_000_000, "spectral spirit shield", 1),
        // Endgame T90+ (tradeable signature pieces)
        new StockEntry(20171, 600_000_000, "zaryte bow",      1),
        new StockEntry(26605, 500_000_000, "drygore mace",    1),
        new StockEntry(28617, 800_000_000, "seismic wand",    1),
        // Other "high tier" classic rares
        new StockEntry(20767, 100_000_000, "off-hand drygore mace", 1),
        new StockEntry(15486, 150_000_000, "staff of light",   1),
    };
