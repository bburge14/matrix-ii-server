...
public final class Settings {
	...
	public static void init() throws UnknownHostException {
		...
		if(Settings.HOSTED) {
			WORLDS_INFORMATION = new WorldInformation[] { 
					new WorldInformation(1, 0, "World1", 0, 0x1 | 0x8, "Europe", "107.202.173.6", 100)
				};
		}else{
			 WORLDS_INFORMATION = new WorldInformation[] { 
						new WorldInformation(1, 0, "World1", 0, 0x1 | 0x8, "Europe", NONHOSTED_SHARING ? "107.202.173.6" : "127.0.0.1", 100)
					};
		}
	...
	public static final String WEB_API_LINK = "http://localhost/matrix/auth.php";
	public static final String HIGHSCORES_API_LINK = "http://localhost/highscores/insert.php";

	public static final String LATEST_UPDATE = "<col=7E2217>Latest Update: Construction and Grand Exchange are now added!";
	public static final String WEBSITE_LINK = "http://localhost";
	public static final String FORUMS_LINK = "http://localhost/cmps_index.php";
	...
	public static final String HIGHSCORES_LINK = "http://localhost/highscores/";
	public static final String VOTE_LINK = "http://localhost/site/index.php?page=vote";
	public static final String DONATE_LINK = "http://localhost/site/index.php?page=donate";
	public static final String STORE_LINK = "http://localhost/site/index.php?page=store";
	public static final String OFFENCES_LINK = "http://localhost/site/index.php?page=offences";
	public static final String EMAIL_LINK = "http://localhost/site/index.php?page=change_email";
	public static final String PASSWORD_LINK = "http://localhost/site/index.php?page=change_password";
	...
	public static final String WIKI_LINK = "http://localhost/wiki/CorruptionX_Wiki";
	public static final String HELP_LINK = "http://localhost/wiki/Beginners%27_Guide";
