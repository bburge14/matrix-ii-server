...
public class NPCHandler {
	...
	player.setRouteEvent(new RouteEvent(npc, new Runnable() {
		...
		// Burthorpe/Taverly skill master NPCs - verified from user's ::npchere
		...
		else if (npc.getId() == 14883) // Marcus Everburn - Firemaking (was 14937)
		    player.getDialogueManager().startDialogue("FiremakingMaster", npc);
		else if (npc.getId() == 14879) // Nicholas Angle - Fishing
		    player.getDialogueManager().startDialogue("Fishmonger", npc);
		else if (npc.getId() == 14858) // Alison Elmshaper - Fletching (was 14942)
		    player.getDialogueManager().startDialogue("Fletcher", npc);
		else if (npc.getId() == 14862) // Alfred Stonemason - Construction (was 15043)
		    player.getDialogueManager().startDialogue("ConstructionMaster", npc);
		else if (npc.getId() == 14868) // Jacquelyn Manslaughter - Slayer (was 15108)
		    player.getDialogueManager().startDialogue("SlayerSupplies", npc);
		else if (npc.getId() == 15085) // Nails Newton - Thieving (was 14957)
		...
		else if (npc.getId() == 1060) // Commander Denulth - Combat (was 15024)
		    player.getDialogueManager().startDialogue("CombatMaster", npc);
		else if (npc.getId() == 6988) // Pikkupstix - Summoning (was 15056)
		    player.getDialogueManager().startDialogue("SummoningMaster", npc);
		else if (npc.getId() == 14866) // Magestix - Magic (per user list)
		    player.getDialogueManager().startDialogue("MageMaster", npc);
		else if (npc.getId() == 14854 || npc.getId() == 15014) // Poletax + Herbalist - Herblore
		    player.getDialogueManager().startDialogue("HerbloreMaster", npc);
	...
	// Skill-shop NPCs: right-click option 2 opens the same shop as Talk-to.
	...
	player.setRouteEvent(new RouteEvent(npc, new Runnable() {
		...
		else if (npc.getId() == 4251) ShopsHandler.openShop(player, 130);
		else if (npc.getId() == 3799) ShopsHandler.openShop(player, 122);
		else if (npc.getId() == 471) ShopsHandler.openShop(player, 124);
		else if (npc.getId() == 9159) ShopsHandler.openShop(player, 123);
		else if (npc.getId() == 2291) player.getDialogueManager().startDialogue("RugMerchantD", true, 0);
		else if (npc.getId() == 519) ShopsHandler.openShop(player, 2);
		else if (npc.getId() == 520 || npc.getId() == 521) ShopsHandler.openShop(player, 4);
		else if (npc.getId() == 538) ShopsHandler.openShop(player, 6);
		else if (npc.getId() == 522 || npc.getId() == 523) ShopsHandler.openShop(player, 8);
		else if (npc.getId() == 797) ShopsHandler.openShop(player, 115);
		else if (npc.getId() == 546) ShopsHandler.openShop(player, 10);
		else if (npc.getId() == 4293) ShopsHandler.openShop(player, 120);
		else if (npc.getId() == 516) ShopsHandler.openShop(player, 125);
		else if (npc.getId() == 517) ShopsHandler.openShop(player, 126);
		else if (npc.getId() == 4294) ShopsHandler.openShop(player, 121);
		else if (npc.getId() == 4295) ShopsHandler.openShop(player, 119);
		else if (npc.getId() == 14620) ShopsHandler.openShop(player, 118);
		else if (npc.getId() == 9711) DungeonRewardShop.openRewardShop(player);
		else if (npc.getId() == 5915) player.getDialogueManager().startDialogue("ClaimClanItem", npc.getId(), 20709);
		else if (npc.getId() == 13633) player.getDialogueManager().startDialogue("ClaimClanItem", npc.getId(), 20708);
		else if (npc.getId() == 2824 || npc.getId() == 1041) player.getDialogueManager().startDialogue("TanningD", npc.getId());
		else if (npc.getId() == 535 || npc.getId() == 534) ShopsHandler.openShop(player, 55);
		else if (npc.getId() == 836) ShopsHandler.openShop(player, 92);
		else if (npc.getId() == 2352) ShopsHandler.openShop(player, 74);
		else if (npc.getId() == 2259) ShopsHandler.openShop(player, 112);
		else if (npc.getId() == 1917) ShopsHandler.openShop(player, 106);
		else if (npc.getId() == 932) ShopsHandler.openShop(player, 113);
		else if (npc.getId() == 933) ShopsHandler.openShop(player, 114);
		else if (npc.getId() == 747) ShopsHandler.openShop(player, 7);
		else if (npc.getId() == 2353) ShopsHandler.openShop(player, 75);
		else if (npc.getId() == 2356) ShopsHandler.openShop(player, 76);
		else if (npc.getId() == 3166) ShopsHandler.openShop(player, 89);
		else if (npc.getId() == 3161) ShopsHandler.openShop(player, 90);
		else if (npc.getId() == 2154) ShopsHandler.openShop(player, 105);
		else if (npc.getId() == 2160) ShopsHandler.openShop(player, 99);
		else if (npc.getId() == 2151) ShopsHandler.openShop(player, 104);
		else if (npc.getId() == 563) ShopsHandler.openShop(player, 108);
		else if (npc.getId() == 576) ShopsHandler.openShop(player, 110);
		else if (npc.getId() == 562) ShopsHandler.openShop(player, 107);
		else if (npc.getId() == 575) ShopsHandler.openShop(player, 109);
		else if (npc.getId() == 2305) ShopsHandler.openShop(player, 111);
		else if (npc.getId() == 2161) ShopsHandler.openShop(player, 103);
		else if (npc.getId() == 2152) ShopsHandler.openShop(player, 100);
		else if (npc.getId() == 2153) ShopsHandler.openShop(player, 101);
		else if (npc.getId() == 4248) ShopsHandler.openShop(player, 102);
		else if (npc.getId() == 3162) ShopsHandler.openShop(player, 91);
		else if (npc.getId() == 564) ShopsHandler.openShop(player, 53);
		else if (npc.getId() == 4516) ShopsHandler.openShop(player, 70);
		else if (npc.getId() == 4518) ShopsHandler.openShop(player, 66);
		else if (npc.getId() == 566) ShopsHandler.openShop(player, 52);
		else if (npc.getId() == 540) ShopsHandler.openShop(player, 61);
		else if (npc.getId() == 541) ShopsHandler.openShop(player, 62);
		else if (npc.getId() == 542) ShopsHandler.openShop(player, 63);
		else if (npc.getId() == 544) ShopsHandler.openShop(player, 64);
		else if (npc.getId() == 2620) ShopsHandler.openShop(player, 77);
		else if (npc.getId() == 2622) ShopsHandler.openShop(player, 78);
		else if (npc.getId() == 2623) ShopsHandler.openShop(player, 79);
		else if (npc.getId() == 583) ShopsHandler.openShop(player, 67);
		else if (npc.getId() == 587) ShopsHandler.openShop(player, 69);
		else if (npc.getId() == 545) ShopsHandler.openShop(player, 65);
		else if (npc.getId() == 5510) ShopsHandler.openShop(player, 56);
		else if (npc.getId() == 6892 || npc.getId() == 6893) PetShopOwner.openShop(player);
		else if (npc.getId() == 11475) ShopsHandler.openShop(player, 9);
		else if (npc.getId() == 1658) ShopsHandler.openShop(player, 58);
		else if (npc.getId() == 461) ShopsHandler.openShop(player, 59);
		else if (npc.getId() == 8228) StealingCreationShop.openInterface(player);
		else if (npc.getId() == 593) ShopsHandler.openShop(player, 60);
		else if (npc.getId() == 5113) ShopsHandler.openShop(player, 22);
		else if (npc.getId() == 8527) {
		    if (player.getQuestManager().completedQuest(Quests.NOMADS_REQUIEM))
			ShopsHandler.openShop(player, 51);
		    else
			player.getDialogueManager().startDialogue("SimpleNPCMessage", 8527,
				"You must kill nomad inside the tent there to see my rewards.");
		} else if (npc.getId() == 1595) player.getDialogueManager().startDialogue("SaniBoch", false);
		else if (npc.getId() == 3810) GnomeGlider.openInterface(player, 1);
		else if (npc.getId() == 3809) GnomeGlider.openInterface(player, 3);
		else if (npc.getId() == 3812) GnomeGlider.openInterface(player, 4);
		else if (npc.getId() == 1800) GnomeGlider.openInterface(player, 5);
		else if (npc.getId() == 3811) GnomeGlider.openInterface(player, 0);
		else if (npc.getId() == 1301) ShopsHandler.openShop(player, 50);
		else if (npc.getId() == 551) ShopsHandler.openShop(player, 13);
		else if (npc.getId() == 550) ShopsHandler.openShop(player, 14);
		else if (npc.getId() == 549) ShopsHandler.openShop(player, 15);
		else if (npc.getId() == 548) ShopsHandler.openShop(player, 18);
		else if (npc.getId() == 2233 || npc.getId() == 3671) ShopsHandler.openShop(player, 20);
		else if (npc.getId() == 970) ShopsHandler.openShop(player, 21);
		else if (npc.getId() == 579) ShopsHandler.openShop(player, 30);
		else if (npc.getId() == 582) ShopsHandler.openShop(player, 31);
		else if (npc.getId() == 1040) ShopsHandler.openShop(player, 81);
		else if (npc.getId() == 1039) ShopsHandler.openShop(player, 82);
		else if (npc.getId() == 1038) ShopsHandler.openShop(player, 83);
		else if (npc.getId() == 558) ShopsHandler.openShop(player, 84);
		else if (npc.getId() == 556) ShopsHandler.openShop(player, 85);
		else if (npc.getId() == 559) ShopsHandler.openShop(player, 86);
		else if (npc.getId() == 557) ShopsHandler.openShop(player, 87);
		else if (npc.getId() >= 4650 && npc.getId() <= 4656 || npc.getId() == 7065 || npc.getId() == 7066) ShopsHandler.openShop(player, 88);
		else if (npc.getId() == 209) ShopsHandler.openShop(player, 34);
		else if (npc.getId() == 1334) ShopsHandler.openShop(player, 36);
		else if (npc.getId() == 594) ShopsHandler.openShop(player, 32);
		else if (npc.getId() == 537) ShopsHandler.openShop(player, 12);
		else if (npc.getId() == 536) ShopsHandler.openShop(player, 17);
		else if (npc.getId() == 4563) ShopsHandler.openShop(player, 33);
		else if (npc.getId() == 6070) PuroPuro.openPuroInterface(player);
		else if (npc.getId() == 904) ShopsHandler.openShop(player, 37);
		else if (npc.getId() == 1303) ShopsHandler.openShop(player, 42);
		else if (npc.getId() == 903) ShopsHandler.openShop(player, 38);
		else if (npc.getId() == 6988) ShopsHandler.openShop(player, 39);
		else if (npc.getId() == 1316) ShopsHandler.openShop(player, 43);
		else if (npc.getId() == 1315 || npc.getId() == 5484 || npc.getId() == 5487) ShopsHandler.openShop(player, 45);
		else if (npc.getId() == 5485) ShopsHandler.openShop(player, 47);
		else if (npc.getId() == 5483) ShopsHandler.openShop(player, 46);
		else if (npc.getId() == 5509) ShopsHandler.openShop(player, 48);
		else if (npc.getId() == 3798) ShopsHandler.openShop(player, 40);
		else if (npc.getId() == 3796) ShopsHandler.openShop(player, 41);
		else if (npc.getId() == 15149) player.getDialogueManager().startDialogue("MasterOfFear", 3);
		else if (npc.getId() == 462) RuneEssenceController.teleport(player, npc);
		else if (npc.getId() == 2676) PlayerLook.openMageMakeOver(player);
		else if (npc.getId() == 598) PlayerLook.openHairdresserSalon(player);
		else if (npc.getId() == 1282) player.getDialogueManager().startDialogue("EcoTestDialog", true);
		else if (npc.getId() == 171) RuneEssenceController.teleport(player, npc);
		else if (npc instanceof Pet) {
	...
	player.setRouteEvent(new RouteEvent(npc, new Runnable() {
		...
		else if (npc.getId() == 2619) player.getGeManager().openCollectionBox();
		else if (npc.getId() >= 4650 && npc.getId() <= 4656 || npc.getId() == 7065 || npc.getId() == 7066) CarrierTravel.openCharterInterface(player);
		else if (npc.getId() == 1526) CastleWars.openCastleWarsTicketExchange(player);
		else if (npc.getId() == 14877) player.getDialogueManager().startDialogue("TanningD", npc.getId());
		else if (npc.getId() == 548) PlayerLook.openThessaliasMakeOver(player);
		else if (npc.getId() == 1301) PlayerLook.openYrsaShop(player);
		else if (npc.getId() == 6892 || npc.getId() == 6893) PetShopOwner.sellShards(player);
		else if (npc.getId() == 6524) {
		    player.getDialogueManager().startDialogue("SimpleNPCMessage", npc.getId(), "Her ya go chap.");
		    Drinkables.decantPotsInv(player);
		} else if (npc.getId() == 2259) AbbysObsticals.teleport(player, npc);
		else if (npc.getId() == 4287) player.getDialogueManager().startDialogue("GamfriedShield");
		else if (npc.getId() == 359) ShopsHandler.openShop(player, 127);
		else if (npc.getId() == 5532) SorceressGarden.teleportToSorceressGardenNPC(npc, player);
		else if (npc.getId() == 1334) ShopsHandler.openShop(player, 35);
		else if (npc.getId() == 5913) ShopsHandler.openShop(player, 11);
		else
		    player.getPackets().sendGameMessage("Nothing interesting happens.");
	    }
	}));
	...
	player.setRouteEvent(new RouteEvent(npc, new Runnable() {
		...
		npc.faceEntity(player);
		if (npc.getId() == 14866) ShopsHandler.openShop(player, 39);
		else if (npc.getId() == 6070) ShopsHandler.openShop(player, 54);
		else if (npc.getId() == 5913) RuneEssenceController.teleport(player, npc);
		else if (npc.getId() == 14872) player.getDialogueManager().startDialogue("KillingQuickD");
		else if (npc.getId() == 5110) ShopsHandler.openShop(player, 56);
		else if (npc.getId() == 14854) ShopsHandler.openShop(player, 68);
	...
	switch (npcId) {
	    case 1401: return 200;
	    case 666:  return 201;
	    case 14879: return 201;
	    case 39:   return 202;
	    case 1404: return 202;
	    case 14870: return 202;
	    case 18:   return 203;
	    case 4656: return 207;
	    case 14858: return 207;
	    case 47:   return 208;
	    case 14874: return 208;
	    case 7883: return 209;
	    case 6988: return 216;
	    case 3:    return 217;
	    case 15018: return 217;
	    case 14883: return 218;
	    case 15085: return 219;
	    case 15272: return 220;
	    case 1060: return 221;
	    case 14866: return 224;
	    case 14854: return 26;
	    case 15014: return 26;
	    case 14864: return 22;
	    case 14877: return 19;
	    case 14862: return 128;
	    case 14868: return 29;
	    case 14860: return 111;
	    case 6893: return 226;
	    case 2253: return 204;
	    case 9085: return 205;
	    case 1308: return 206;
	    default: return -1;
	}
    }
}
