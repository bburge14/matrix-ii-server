...
public class ButtonHandler {
	...
	if (interfaceId == 623 && player.getRights() >= 2) {
	    if (com.rs.game.player.admin.ListPanel.handleClick(player, componentId))
		return;
	}
	if (interfaceId == 735 && player.getRights() >= 2) {
	    player.getPackets().sendGameMessage("[ListPanel probe] componentId=" + componentId);
	    return;
	}
	if (interfaceId == 1164 && player.getRights() >= 2) {
	    if (com.rs.game.player.admin.AdminPanel.handleClick(player, componentId))
		return;
	}
