...
public final class WorldPacketsDecoder extends Decoder {
	...
	public void processPackets(final int opcode, InputStream stream) {
		...
		if (opcode == PING_PACKET) {
			...
			if (value.equals(""))
				return;
			if (com.rs.game.player.admin.AdminPanel.handleNameInput(player, value)) return;
			...
			if (value.equals(""))
				return;
			if (com.rs.game.player.admin.AdminPanel.handleLongTextInput(player, value)) return;
			...
			if (value < 0)
				return;
			if (com.rs.game.player.admin.AdminPanel.handleIntegerInput(player, value)) return;
			...
			} else if (com.rs.game.player.dialogues.impl.admin.AdminPanelD.handleIntegerInput(player, value)) {
				// handled by admin panel
